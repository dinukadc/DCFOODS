...
%>
<!--cart popup window-->
		  <form method="post" action="cardUpdate">
	<div class="pop">
		<div class="c-close-content">
		   <img src="images/cancel.png" alt="Cancel" class="cancel">
		  </div>
		<div class="pop-content">
		<input list="SlotId" name="sloId" id="slotid" placeholder="Slot id.." required>
		 <datalist id="SlotId">
		 <option value="s1">
		 <option value="s2">
		 <option value="s3">
		 ...
		 <option value="s8">
		  ...
		  <input type="text" placeholder="Item Price (Display).." name="iprice" required>
		 <input list="ItemType" name="Itype" id="Itype" placeholder="Item Type.." required>
		 ...
		 <textarea rows="8" cols="36" name="recipe" placeholder="Enter recipe here.." required></textarea>
		 <input type="text" id="imgId" placeholder=" foldername/imagename.jpg (200x180 only)" name="img" required>
		 <br><br>
...
%>	
	...
	<div class="product">
		...
		<div class="specifice">
			...
			<button class="buy" type="button">Edit Cart</button>
		</div>
	</div>
	<%
}
...
%>	
	...
	var editOption = document.getElementsByClassName("buy")
	for(var i=0;i< editOption.length; i++){
	     var editIndex=editOption[i]
	 editIndex.addEventListener("click",editclicked)
	}	
	...
	document.getElementById("Itype").addEventListener("click",function(){
